    ...
    <div className="flex-1 space-y-8 relative">
      ...
      <div className="flex flex-col gap-4 text-gray-400 max-w-lg font-mono text-sm border-l-2 border-cyan-500/30 pl-6 py-2 bg-gradient-to-r from-cyan-500/5 to-transparent">
        <div className="flex items-center gap-3 group cursor-pointer hover:text-cyan-300 transition-colors">
          ...
          <a href="mailto:augustoamado.profissional@gmail.com" aria-label="Enviar e-mail para Augusto Amado">
        ...
        <div className="flex items-center gap-3 group cursor-pointer hover:text-cyan-300 transition-colors">
          ...
          <a href="https://wa.me/5535999484693" target="_blank" rel="noopener noreferrer" aria-label="Abrir conversa no WhatsApp">
            +55 (35) 99948-4693
          </a>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 pt-6 items-center">
        ...
        <div className="flex gap-4">
          <a href="https://github.com/augusto-amado" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" size="icon" className="h-12 w-12 rounded-none border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/20 hover:text-cyan-300 hover:border-cyan-500 shadow-[0_0_10px_rgba(34,211,238,0.1)] transition-all" aria-label="Abrir GitHub de Augusto Amado">
              <GithubIcon className="h-5 w-5" />
            </Button>
          </a>
          <a href="https://www.linkedin.com/in/augusto-amado-89507823a/" target="_blank" rel="noopener noreferrer">
            <Button variant="outline" size="icon" className="h-12 w-12 rounded-none border-cyan-500/30 text-cyan-400 hover:bg-cyan-500/20 hover:text-cyan-300 hover:border-cyan-500 shadow-[0_0_10px_rgba(34,211,238,0.1)] transition-all" aria-label="Abrir LinkedIn de Augusto Amado">
