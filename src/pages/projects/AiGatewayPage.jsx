...
import { GitCompare, Network, Radio, LayoutTemplate, Rocket, Database, Workflow } from 'lucide-react'
import { Separator } from '@/components/ui/separator'
import ProjectLayout, { FeatureSection, StatCard, MediaPlaceholder } from '@/components/ProjectLayout'
import { useLanguage } from '@/hooks/useLanguage'
import { getAccent } from '@/lib/accents'
import { aiGatewayTranslations } from '@/i18n/projects/aiGateway'

const ACCENT = 'emerald'
const a = getAccent(ACCENT)

const tags = [
  'Go', 'React', 'Vite', 'Tailwind CSS', 'SSE', 'Multi-LLM',
  'Ollama', 'OpenAI', 'Anthropic', 'Docker', 'GitHub Actions',
]
    ...
    >
      ...
      <section className="space-y-12">
        ...
        {content.features.map((feature, index) => {
          const Icon = featureIcons[index] || GitCompare
          return (
            <FeatureSection
              key={feature.title}
