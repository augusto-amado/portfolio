    ...
    >
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold flex items-center gap-3 text-white font-mono">
          <span className="text-rose-400 drop-shadow-[0_0_8px_rgba(251,113,133,0.8)]">#</span>
          Visao_Geral
        </h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard accent={ACCENT}value="3 LLMs" label="Claude · GPT · Gemini" />
          <StatCard accent={ACCENT}value="Multi-sheet" label="Google Sheets + CSV" />
          <StatCard accent={ACCENT}value="Metered" label="billing por crédito de IA" />
          <StatCard accent={ACCENT}value="Real-time" label="KPIs e gráficos" />
        </div>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="border-l-2 border-rose-500/30 pl-6 py-2 bg-gradient-to-r from-rose-500/5 to-transparent">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-3">
          {[
            ...
            <div key={item.feature} className="bg-[#0a0a0a] border border-rose-500/10 p-4 rounded-sm hover:border-rose-500/30 transition-colors">
              <div className="text-rose-400 font-mono font-bold text-sm">{item.feature}</div>
      ...
      <section className="space-y-12">
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Modal de mapeamento de colunas" />
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Seleção de abas por canal" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Relatório gerado com análise por canal" />
            <Screenshot accent={ACCENT}
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            />
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Gráfico Spend vs Leads semanal" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Thread de QA com perguntas e respostas sobre o relatório" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Cards de campanhas com métricas detalhadas" />
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Modal de configuração de colunas" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Card de roteiro com versões" />
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Editor de roteiro gerado" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Card de briefing da empresa gerado pelo site" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14 grid grid-cols-3 gap-3">
            {[
              ...
              <div key={model.name} className="bg-[#0a0a0a] border border-rose-500/10 p-4 rounded-sm text-center">
                <div className="text-rose-400 font-mono font-bold text-sm">{model.name}</div>
        ...
        >
          <div className="ml-14 grid grid-cols-1 md:grid-cols-2 gap-4">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Lista de projetos na sidebar" />
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Modal de convite de membro" />
          </div>
        </FeatureSection>
        ...
        >
          <div className="ml-14">
            <MediaPlaceholder accent={ACCENT} label="Screenshot — Painel de billing com histórico de uso" />
          </div>
        </FeatureSection>
      </section>
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-bold flex items-center gap-3 text-white font-mono">
          <BarChart3 className="h-6 w-6 text-rose-400 drop-shadow-[0_0_8px_rgba(251,113,133,0.8)]" />
          Arquitetura
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Frontend */}
          <div className="bg-[#0a0a0a] border border-rose-500/10 p-6 rounded-sm space-y-4">
            <h3 className="text-sm font-mono uppercase tracking-widest text-rose-400 border-b border-rose-500/20 pb-2">
              Frontend
            </h3>
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-bold flex items-center gap-3 text-white font-mono">
          <Brain className="h-6 w-6 text-rose-400 drop-shadow-[0_0_8px_rgba(251,113,133,0.8)]" />
          Desafios_Técnicos
        </h2>
        ...
        <div className="space-y-6">
          {[
            ...
            <div key={i} className="border-l-2 border-rose-500/20 pl-6 py-2 hover:border-rose-500/50 transition-colors">
